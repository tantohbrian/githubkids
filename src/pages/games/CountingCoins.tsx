          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              ...
              <p className="text-sm-system text-gray-600">
                Count coins to reach target amounts!
              </p>
            </div>
            <div></div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl text-center">
            <div className="mb-8">
              ...
              <p className="text-sm-system text-gray-600 mb-6">
                This fun counting game will help you learn about Bitcoin values
                by counting different coin amounts to reach target totals!
              </p>
            </div>

            <div className="bg-gradient-to-r from-amber-100 to-yellow-100 rounded-2xl p-6 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm-system text-gray-700">
                    Count Different Coins
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-2xl">🎯</span>
                  <span className="text-sm-system text-gray-700">
                    Reach Target Amounts
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-2xl">📊</span>
                  <span className="text-sm-system text-gray-700">
                    Learn Bitcoin Values
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-2xl">🎮</span>
